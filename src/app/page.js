...
export default function Home() {
  // usestate is a hook that is used to handle changes on the UI(user interface)
  ...
  // a  function is a reusable block of code that can be called upon
...
<form class="max-w-md mx-auto" onSubmit={HandleSubmit}>
  ...
  <div class="grid md:grid-cols-2 md:gap-6">
    ...
    <div class="relative z-0 w-full mb-5 group">
        <input type="text" name="floating_company" id="floating_company" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required  onChange={(e)=>setCompany(e.target.value)}/>
